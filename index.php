        ...
        <div class="side-menu flex-lg-column mr-lg-1">
            ...
            <div class="flex-lg-column my-auto">
                <ul class="nav nav-pills side-menu-nav justify-content-center" role="tablist">
                    ...
                    <li class="nav-item" data-toggle="tooltip" data-trigger="hover" data-placement="top"
                        title="Friend's">
                        <a class="nav-link" id="pills-contacts-tab" data-toggle="pill" href="#pills-contacts"
                            role="tab">
                    ...
                    <li class="nav-item dropdown profile-user-dropdown d-inline-block d-lg-none">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" data-toggle="pill" href="#pills-user">Profile <i
                                    class="ri-profile-line float-right text-muted"></i></a>
                            <a class="dropdown-item" data-toggle="pill" href="#pills-setting">Setting <i
                                    class="ri-settings-3-line float-right text-muted"></i></a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="/logout">Log out <i
                        ...
                        <div class="p-4 user-profile-desc" data-simplebar>
                            ...
                            <div id="profile-user-accordion-1" class="custom-accordion">
                                    ...
                                    <div id="profile-user-collapseOne" class="collapse show"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <h5 class="font-size-14">15-sep-1998</h5>
                                            </div>
                                ...
                                <div class="card mb-1 shadow-none border">
                                    <a href="#profile-user-collapseTwo" class="text-dark collapsed"
                                    ...
                                    <div id="profile-user-collapseTwo" class="collapse"
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body overflow-hidden">
                                                    ...
                                                    <p class="chat-user-message text-truncate mb-0"><i
                                                            class="ri-image-fill align-middle mr-1"></i> Images</p>
                                                </div>
                                        ...
                                        <a href="#">
                                            <div class="media">
                                                ...
                                                <div class="media-body overflow-hidden">
                                                    ...
                                                    <p class="chat-user-message text-truncate mb-0"><i
                                                            class="ri-file-text-fill align-middle mr-1"></i> Admin-A.zip
                                                    </p>
                                                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title font-size-16" id="addgroup-exampleModalLabel">Create
                                                New Group</h5>
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <div class="mb-3">
                                                        <button class="btn btn-light btn-sm" type="button"
                                                            data-toggle="collapse" data-target="#groupmembercollapse"
                                                    ...
                                                    <div class="collapse" id="groupmembercollapse">
                                                        <div class="card border">
                                                            <div class="card-header">
                                                                <h5 class="font-size-15 mb-0">Friend's</h5>
                                                            </div>
                                                                            ...
                                                                            <li>
                                                                                <div
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                        ...
                                                                                        id="memberCheck1">
                                                                                    <label class="custom-control-label" for="memberCheck1">
                                                                                        <div class="media">
                                                                            ...
                                                                            <li>
                                                                                <div
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                        class="custom-control-input"
                                                                                        id="memberCheck2">
                                                                                    <label class="custom-control-label" for="memberCheck2">
                                                                                        <div class="media">
                                                                            ...
                                                                            <li>
                                                                                <div
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                        class="custom-control-input"
                                                                                        id="memberCheck3">
                                                                                    <label class="custom-control-label" for="memberCheck3">
                                                                                        <div class="media">

                                                                                            <div class="chat-user-img3">
                                                                                                <div class="avatar-xs">
                                                                                                    <span
                                                                                                        class="avatar-title rounded-circle bg-soft-primary text-primary">
                                                                                                        G
                                                                            ...
                                                                            <li>
                                                                                <div
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                        class="custom-control-input"
                                                                                        id="memberCheck4">
                                                                                    <label class="custom-control-label" for="memberCheck4">
                                                                                        <div class="media">
                                                                            ...
                                                                            <li>
                                                                                <div
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                        class="custom-control-input"
                                                                                        id="memberCheck5">
                                                                                    <label class="custom-control-label" for="memberCheck5">
                                                                            ...
                                                                            <li>
                                                                                <div
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                        class="custom-control-input"
                                                                                        id="memberCheck6">
                                                                                    <label class="custom-control-label" for="memberCheck6">
                                                                            ...
                                                                            <li>
                                                                                <div
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                        class="custom-control-input"
                                                                                        id="memberCheck7">
                                                                                    <label class="custom-control-label" for="memberCheck7">
                                                                            ...
                                                                            <li>
                                                                                <div
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                        class="custom-control-input"
                                                                                        id="memberCheck8">
                                                                                    <label class="custom-control-label" for="memberCheck8">
                                                                            ...
                                                                            <li>
                                                                                <div
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                        class="custom-control-input"
                                                                                        id="memberCheck9">
                                                                                    <label class="custom-control-label" for="memberCheck9">
                                                                            ...
                                                                            <li>
                                                                                <div
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                        class="custom-control-input"
                                                                                        id="memberCheck10">
                                                                                    <label class="custom-control-label" for="memberCheck10">
                                                                            ...
                                                                            <li>
                                                                                <div
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                        class="custom-control-input"
                                                                                        id="memberCheck11">
                                                                                    <label class="custom-control-label" for="memberCheck11">
                                                                            ...
                                                                            <li>
                                                                                <div
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                        class="custom-control-input"
                                                                                        id="memberCheck12">
                                                                                    <label class="custom-control-label" for="memberCheck12">
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body overflow-hidden">
                                                <h5 class="text-truncate font-size-14 mb-0">#Reporting <span
                                                        class="badge badge-soft-danger badge-pill float-right">+23</span>
                                                </h5>
                                            </div>
                                        </div>
                                    </a>
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body overflow-hidden">
                                                <h5 class="text-truncate font-size-14 mb-0">#Developers <span
                                                        class="badge badge-soft-danger badge-pill float-right">New</span>
                                                </h5>
                                            </div>
                                        </div>
                                    </a>
                ...
                <div class="tab-pane" id="pills-contacts" role="tabpanel" aria-labelledby="pills-contacts-tab">
                    ...
                    <div>
                        ...
                        <div class="p-4 chat-message-list chat-group-list" data-simplebar>
                                    ...
                                    <li>
                                        <div class="media align-items-center">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#">Accept<i
                                                            class="ri-user-add-line float-right text-muted"></i></a>
                            ...
                            <!-- end contact list of Friend Request -->
                            ...
                            <!-- end contact list of Friend suggestion -->
                        </div>
                        <!-- end contact lists -->
                    </div>
                    <!-- Start Contact content -->
                    ...
                    <div>
                        ...
                        <div class="p-4 user-profile-desc" data-simplebar>
                            ...
                            <div id="profile-setting-accordion" class="custom-accordion">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="float-right">
                                                <button type="button" class="btn btn-light btn-sm"><i
                                                        class="ri-edit-fill mr-1 align-middle"></i> Edit</button>
                                            </div>
                                ...
                                <!-- end profile card -->
                                <div class="card shadow-none border mb-2">
                                    <a href="#profile-setting-privacycollapse" class="text-dark collapsed"
                                        data-toggle="collapse" aria-expanded="false"
                                ...
                                <div class="card shadow-none border mb-2">
                                    <a href="#profile-setting-securitynoticollapse" class="text-dark collapsed"
                                        data-toggle="collapse" aria-expanded="false"
